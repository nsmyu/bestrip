      ...
      infowindow[i] =
        new google.maps.InfoWindow({
          content:
            ...
            <a href="/itineraries/${document.getElementById("itinerary_id").value}/destinations/new?place_id=${places[i].place_id}" class="btn btn-sm btn-outline-primary mb-0 w-100" data-turbo-frame="modal">スポット情報を見る</a>
            </div>
            </div>`
        })
